'''by tm
视觉指令进行开放目标检测;
model:output_20250120/EPOCH-1-AP0_obj365&openimage_swin_T_size1024_-loss-2.038524391321923.pth
实现同图精度0.6027073501230146，但是跨图精度很低，对应测试结果：
eval_csv/EPOCH-1-Swin-Trandom-class-select-0122_zore-shot_coco_I.csv
改进：使用全局的外部记忆存储变量进行跨图的提示学习。设置每个类别的最大长度64，
随机选择（1，4，18，32，64）取均值作为跨图提示，
外部记忆的更新策略？
'''
