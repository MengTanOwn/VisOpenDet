...
if __name__ == '__main__':
    ...
    points = (torch.rand(2, 2, 2), torch.randint(-1, 2, (2, 2)))
    boxes = torch.rand(12,4)
    masks = torch.rand(2, 1, 32, 32)
    sparse_embeddings, dense_embeddings = prompt_encoder(boxes=boxes,points=None,masks=None)
