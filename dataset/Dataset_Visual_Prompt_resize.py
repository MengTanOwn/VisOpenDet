...
class COCODatasetVisualPrompt(dataset.Dataset):
    def __init__(self,ann_path,image_folder,cate_feat=None,aug=False,extract_box=False,strong_aug=False,train=False,support_norm=False,return_mask=False,mixed_support_selection=False,val_cls_ids=None,region_detect=False,use_text=False,bg_feat=None,use_bg=True,max_support_len=81):
